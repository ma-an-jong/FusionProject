...
public class Protocol {
    ...
    public static final String PT_REQ_FILE = "5"; //파일 전송 데이터 TODO:
    ...
    //개설 교과목 목록 조회
    public static final String CS_REQ_OPENSUBJECT_VIEW = "7-6"; //개설 교과목 목록 조회
    public static final String SC_RES_OPENSUBJECT_VIEW = "8-C"; //개설 교과목 목록 조회 응답
    //선택 교과목 강의계획서 조회
    ...
    //개설 교과목 생성, 수정, 삭제
    public static final String CS_REQ_LECTURE_ENROLL = "9-7"; //교과목 등록 요청
    public static final String SC_RES_LECTURE_ENROLL = "A-E"; //교과목 등록 요청 응답
    public static final String CS_REQ_LECTURE_UPDATE = "B-5"; //교과목 수정 요청
    public static final String SC_RES_LECTURE_UPDATE = "C-C"; //교과목 수정 요청 응답
    public static final String CS_REQ_LECTURE_DELETE = "B-6"; //교과목 삭제 요청
    public static final String SC_RES_LECTURE_DELETE = "C-E"; //교과목 삭제 요청 응답
    ...
    public void setPacket (String[] stringValue)
    {
        ...
        packet += protocolType + splitter; // TODO:
